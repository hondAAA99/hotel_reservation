...
class roomServices {
    ...
    _reservationRepo;
    _payment;
    constructor(_userRepo = userRepo, _roomRepo = roomRepo, _roomTypesRepo = roomTypesRepo, _reservationRepo = reservationRepo, _payment = new paymentService()) {
        this._userRepo = _userRepo;
        this._roomRepo = _roomRepo;
        this._roomTypesRepo = _roomTypesRepo;
    ...
    async addRoom(body) {
        ...
        try {
            ...
            if (!getRoomType)
                return ErrorInternalServerError('cannot find room type');
    ...
    async searchAvailableRooms(query) {
