...
import { PREFIX_ADMIN_TOKEN, SECRET_ADMIN_ACCESS_TOKEN, SECRET_USER_ACCESS_TOKEN, } from '../../config/config.js';
...
export async function authenticate(req, res, next) {
    ...
    const user = (await userRepo.findById({ id: decode.userId }));
    req.user = user;
    next();
}
